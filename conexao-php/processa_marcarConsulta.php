...
try {
    ...
    // 1) Monta e valida data/hora do formulário
    ...
    // 2) Verifica conflito exato no mesmo dia+hora
    ...
    // 3) Soma valores dos procedimentos
    $valorTotal = 0.0;
    if (!empty($procedimentosSelecionados)) {
    ...
    // 4) Insere a consulta (conversão explícita da data no SQL)
    $sqlConsulta = "
